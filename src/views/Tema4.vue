  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
          ...
          .row.align-items-center.justify-content-center
            ...
            .col-lg-8(data-aos="fade-left")
              ...
              .cajon.color-primario.p-4
                p.mb-0 Por mucho tiempo la solución más utilizada ha sido Fibre Channel (FC) y, en los últimos años, han sobresalido tecnologías como NAS o iSCSI, convirtiéndose en alternativas tentadoras para entornos de virtualización, gracias a su diferencia en rendimiento y precio.
    ...
    AcordionA(tipo="b" clase-tarjeta="tarjeta bg-2")
      .row.justify-content-center(titulo="DAS <em>Direct Attached Storage</em>")
        .col-12.mb-4
          p Son dispositivos de almacenamiento directamente conectados a la máquina, como es el caso de discos duros internos, cabinas de disco o unidades de cinta para “backup”.
          .row.align-items-center.mb-4
            .col-1
              img.mx-auto(src="@/assets/curso/temas/t4/ptos1.svg", style="max-width: 40px;")
            .col-11
              p.mb-0 Suelen basarse en tecnologías SCSI- Small Computers System Interface y FC- Fiber Channel. Esta arquitectura de almacenamiento se relacionaba principalmente con la época de los “Mainframe” de IBM. Sin embargo, hoy en día, los PC’s de sobremesa utilizan arquitectura de almacenamiento DAS, mientras que, en los servidores de las empresas, empieza a caer en desuso, utilizándose únicamente para el almacenamiento del sistema operativo.
          .cajon.color-acento-contenido.c2.p-4.mb-3
            p.mb-0 La arquitectura de almacenamiento DAS presenta muchos inconvenientes, como la dispersión del almacenamiento, que implica una dificultad en la gestión de los backups, así como una baja tolerancia a fallos (sólo posible a través de soluciones RAID), y un alto TCO- Total Cost of Ownership, debido a las dificultades de mantenimiento.
        .col-md-6
          ...
          .row.align-items-center
            ...
            .col-md-8
              .row.align-items-center.mb-4
                ...
                .col-11
                  p.mb-0.fw-bold.t-blue Los principales beneficios de las Arquitecturas de Almacenamiento NAS son los que proporcionan un mejor TCO -Total Cost of Ownship, resultando fácilmente escalable y capaces de ofrecer una alta disponibilidad.
              .bg-6.p-4
      ...
      .row.justify-content-center(titulo="SAN <em>Storage Area Network</em>")
        .col-12
          ...
          .row.align-items-center.mb-4
            ...
            .col-11
              p.mb-0.fw-bold.t-blue Las redes de almacenamiento SAN han facilitado enormemente la creación de Centros de Procesos de Datos (CDP) distribuidos, Clusters Geográficos, creación de centros de respaldo (BDC), etc.
        .col-md-8
    ...
    .bg-4.w-fit.py-2.px-4.mb-4(data-aos="fade")
      h4.text-white.mb-0 iSCSI - #[em Internet Small Computer System Interface]

    p.mb-4(data-aos="fade") Sistema de almacenamiento basado en bloques como FC - #[emFiber Channel]. Se diferencia porque utiliza componentes de una red Ethernet tradicional para realizar la conexión entre los hosts y el sistema de almacenamiento. Al utilizar componentes Ethernet, iSCSI es más barato de implementar.
    ...
    .bg-4.w-fit.py-2.px-4.mb-4(data-aos="fade")
      h4.text-white.mb-0 FC - #[em Fiber channel]
      ...
      .col-lg-9(data-aos="fade-left")
        .tarjeta-avatar-b.mb-4
          ...
          .tarjeta.bg-1.bx-sh1
            .p-4
              h3 Seguridad
              p.mb-0 Las redes de almacenamiento basadas en FC en principio son más seguras que las basadas en Ethernet ya que el tráfico está aislado del tráfico normal. Pero por otro lado es más complicado implementar sistemas de autenticación y encriptación.
        .tarjeta-avatar-b
          .tarjeta-avatar-b__img
    ...
    TabsB.color-acento-botones(data-aos="fade-down")
        ...
        .row.justify-content-evenly
          .col-md-6.mb-4.mb-md-0
            ...
            .row.align-items-center.mb-4.ps-md-3.ps-lg-4
              ...
              .col-11
                p.mb-0 De este modo, se descarga al dispositivo de almacenamiento de la responsabilidad de escribir datos a disco. NAS utiliza un #[em software] cliente que se comunica al servidor NFS mediante red Ethernet.
          .col-md-4
            img(src='@/assets/curso/temas/t4/tab2-img1.svg' alt='')
      .py-4.py-md-5.bg-5(titulo="Costo y rendimento" :icono="require('@/assets/curso/temas/t4/tab2-ico2.svg')")
        .row.justify-content-evenly
          .col-md-6.mb-4.mb-md-0
      ...
      .py-4.py-md-5.bg-5(titulo="Desventajas" :icono="require('@/assets/curso/temas/t4/tab2-ico1.svg')")
